 ...
 */
public class VideoCategoryFragment extends BaseFragment implements OnMediaListener<Video> {
	private static final String TAG = "VideoCategoryFragment";
	...
	private void initView() {
		...
		adapter = new LinearAdapter(this, IMediaStore.MEDIA_TYPE_VIDEO);
			...
			public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
				switch (newState) {
					case SCROLL_STATE_SETTLING:
						Glide.with(VideoCategoryFragment.this).pauseRequests();
						break;
					case SCROLL_STATE_IDLE:
						Glide.with(VideoCategoryFragment.this).resumeRequests();
						break;
